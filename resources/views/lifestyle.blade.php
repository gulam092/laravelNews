		...
		<!-- //btm-wthree-left -->
				...
				<div class="wthree-top-6">
					...
					<div class="col-md-6 w3-lft">
						<div class="w3agile_special_deals_grid_left_grid">
							<a href="singlepage.html"><img src="{{asset('public/front/images/5.jpg')}}" class="img-responsive" alt="" /></a>
						</div>
					</div>
					<div class="col-md-6 w3-rgt">
						<div class="w3-rgt-top">
							<div class="w3agile_special_deals_grid_left_grid">
								<a href="singlepage.html"><img src="{{asset('public/front/images/g6.jpg')}}" class="img-responsive" alt="" /></a>
							</div>
						</div>
						<div class="w3-rgt-top1">
							<div class="w3agile_special_deals_grid_left_grid">
								<a href="singlepage.html"><img src="{{asset('public/front/images/g8.jpg')}}" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
			...
			<!-- wthree-top-1 -->
				<div class="wthree-top-1">
					<div class="w3agile-top">
						<div class="w3agile_special_deals_grid_left_grid">
							<a href="singlepage.html"><img src="{{asset('public/front/images/4.jpg')}}" class="img-responsive" alt="" /></a>
						</div>
						<div class="w3agile-middle">
						<ul>
							<li><a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>FEB 15,2017</a></li>
