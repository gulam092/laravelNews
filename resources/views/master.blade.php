			...
			<div class="col-md-3 w3agile_blog_left">
				...
				<div class="w3l_categories">
					...
					<ul>
						...
						<li><a href="{{url('/category/'.$data->id.'/'.$data->cname)}}"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>{{$data->cname}}</a></li>
						@endforeach
					</ul>
				</div>
			<div class="w3ls_recent_posts">
					...
					<div class="agileits_recent_posts_grid">
						...
						<div class="agileits_recent_posts_gridr">
							...
							<h5><i class="fa fa-calendar" aria-hidden="true"></i>{{$data->date}}</h5>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
