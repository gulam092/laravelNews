		...
		<!-- //btm-wthree-left -->
			...
			<div class="w3ls_work_grids">	
				<div class="col-md-6 agileits_w3layouts_work_grid">	
					<div class="agileits_w3layouts_work_grid1 w3layouts_work_grid1 hover14 column">
						<div class="w3_agile_work_effect">
							<a href="{{asset('public/front/images/p1.jpg')}}" class="sb" title="quis nostrud exercitation ullamco laboris quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum">
								<figure>
									<img src="{{asset('public/front/images/p1.jpg')}}" alt=" " class="img-responsive" />
								</figure>
							</a>
						</div>
					</div>
					<div class="agileits_w3layouts_work_grid1 hover14 column">
						<div class="w3_agile_work_effect">
							<a href="{{asset('public/front/images/5.jpg')}}" class="sb" title="quis nostrud exercitation ullamco laboris quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum">
								<figure>
									<img src="{{asset('public/front/images/5.jpg')}}" alt=" " class="img-responsive" />
								</figure>
							</a>
						</div>
					</div>
					<div class="agileits_w3layouts_work_grid1 hover14 column">
						<div class="w3_agile_work_effect">
							<a href="{{asset('public/front/images/p2.jpg')}}" class="sb" title="quis nostrud exercitation ullamco laboris quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum">
								<figure>
									<img src="{{asset('public/front/images/p2.jpg')}}" alt=" " class="img-responsive" />
								</figure>
							</a>
						</div>
					</div>
					...
					<div class="agileits_w3layouts_work_grid1 hover14 column">
						<div class="w3_agile_work_effect">
							<a href="{{asset('public/front/images/p3.jpg')}}" class="sb" title="quis nostrud exercitation ullamco laboris quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum">
								<figure>
									<img src="{{asset('public/front/images/p3.jpg')}}" alt=" " class="img-responsive" />
								</figure>
							</a>
						</div>
					</div>
					<div class="agileits_w3layouts_work_grid1 hover14 column">
						<div class="w3_agile_work_effect">
							<a href="{{asset('public/front/images/g6.jpg')}}" class="sb" title="quis nostrud exercitation ullamco laboris quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum">
								<figure>
									<img src="{{asset('public/front/images/g6.jpg')}}" alt=" " class="img-responsive" />
								</figure>
							</a>
						</div>
					</div>
				...
				<div class="col-md-6 agileits_w3layouts_work_grid-1">	
					...
					<div class="agileits_w3layouts_work_grid1 hover14 column">
						<div class="w3_agile_work_effect">
							<a href="{{asset('public/front/images/g7.jpg')}}" class="sb" title="quis nostrud exercitation ullamco laboris quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum">
								<figure>
									<img src="{{asset('public/front/images/g7.jpg')}}" alt=" " class="img-responsive" />
								</figure>
							</a>
						</div>
					</div>
					...
					<div class="agileits_w3layouts_work_grid1 hover14 column">
						<div class="w3_agile_work_effect">
							<a href="{{asset('public/front/images/g8.jpg')}}" class="sb" title="quis nostrud exercitation ullamco laboris quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum">
								<figure>
									<img src="{{asset('public/front/images/g8.jpg')}}" alt=" " class="img-responsive" />
								</figure>
							</a>
						</div>
					</div>
				...
				<div class="w3ls_popular_posts">
					...
					<div class="agileits_popular_posts_grid">
						<div class="w3agile_special_deals_grid_left_grid">
							<a href="singlepage.html"><img src="{{asset('public/front/images/p1.jpg')}}" class="img-responsive" alt="" /></a>
						</div>
					...
					<div class="agileits_popular_posts_grid">
						<div class="w3agile_special_deals_grid_left_grid">
								<a href="singlepage.html"><img src="{{asset('public/front/images/p2.jpg')}}" class="img-responsive" alt="" /></a>
							</div>
					...
					<div class="agileits_popular_posts_grid">
						<div class="w3agile_special_deals_grid_left_grid">
								<a href="singlepage.html"><img src="{{asset('public/front/images/p3.jpg')}}" class="img-responsive" alt="" /></a>
						</div>
